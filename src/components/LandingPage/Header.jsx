...
const Header = () => {
  ...
  return (
    // <div id="header">
    //   <div className=" bg-[#F7F7F7]  py-10  px-2 sm:px-6 lg:px-28">
    //     <div className="grid grid-cols-2 container mx-auto">
    //       <div className="col-span-2 md:col-span-1 mb-16 md:mb-0">
    //         <p className="text-black text-[42px]  py-4 font-semibold leading-tight">
    //           {t('landingPage.header.title')}
    //         </p>
    //         <Link className="action-botton flex items-center gap-1 w-fit mb-4 !bg-[#DE6DAF] text-white px-3 py-2 rounded-[5px]">
    ...
    //       </div>
    //     </div>
    //     {/* <img src={header_image}  className='object-cover min-h-[300px] ' alt="" /> */}
    //   </div>
    //   <div
    ...
    >
      {slides.map((slide, index) => (
        ...
        {/* <SwiperSlide className="transition flex flex-col lg:h-[calc(100vh-64px)] h-[1000px]" key={index}> */}
          <div className=" bg-[#F7F7F7]  py-10 pb-24 md:pb-10  px-2 sm:px-6 lg:px-28">
            <div className="grid grid-cols-2 container ">
            {/* <div className="grid grid-cols-2 container lg:h-[calc(43vh-64px)]"> */}
              <div className="col-span-2 xl:col-span-1 mb-16 xl:mb-0 ">
                <h2 className="text-black text-[46px]  py-4 fontbold leading-tight">
                  {slide.title}
                </h2>
                <p className="text-gray-700 text-[22px]  py-4 font-normal font- leading-tight">
                  {slide.subtitle}
                </p>
                <Link to={"/pricing"} className="action-botton flex items-center gap-1 w-fit mb-4 !bg-[#DE6DAF] text-white px-3 py-2 rounded-[5px]">
                  <span> {t("landingPage.header.actionButton")} </span>
                  <span className="bounce-botton">
                    <svg
                      width="17"
          ...
          <div
            style={{ backgroundImage: `url(${header_mask})` }}
            className="bg-cover bg-center  min-h-[500px] w-full  relative"
            // className="bg-cover bg-center lg:h-[calc(57vh-64px)] min-h-[500px] w-full  relative"
          >
